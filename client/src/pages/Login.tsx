    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-textMuted mt-2">Operator Login Portal</p>
        </div>

        {/* Login Card */}
        <div className="bg-surface/50 backdrop-blur-xl rounded-2xl border border-border p-8 shadow-2xl">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    "w-full pl-10 pr-4 py-3 bg-surfaceHighlight border rounded-lg",
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    "w-full pl-10 pr-12 py-3 bg-surfaceHighlight border rounded-lg",
                    "text-text placeholder:text-textMuted",
                    "focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary",
                    "border-border transition-all"
                  )}
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <p className="text-xs text-textMuted text-center mb-3">Demo Credentials</p>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="p-2 bg-surfaceHighlight rounded-lg border border-border">
                <p className="text-textMuted">Operator:</p>
                <p className="text-text font-mono">arvind / password123</p>
              </div>
              <div className="p-2 bg-surfaceHighlight rounded-lg border border-border">
                <p className="text-textMuted">Admin:</p>
                <p className="text-text font-mono">admin / admin123</p>
              </div>
            </div>
          </div>
        </div>
